            ...
            <nav data-aos="zoom-out" data-aos-delay={800} className="navbar navbar-expand">
                <div className="container header">
                    ...
                    <ul className="navbar-nav items mx-auto">
                        ...
                        <li className="nav-item dropdown">
                            <a className="nav-link" href="/sell-assets">Sell Digital Assets</a>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link" href="/my-assets">My Digital Assets</a>
                        </li>
                        <li className="nav-item dropdown">
                            <li className="nav-item"><a href="/create-nft" className="nav-link">Create NFT</a></li>
                        </li>
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li className="nav-item"><a href="/faucet" className="nav-link">Adamant Faucet</a></li>
                            </ul>
                        </li>
                        ...
                        {(walletAddress !== '') && (
                            <li className="nav-item">
                                <div style={{display:"inline-block"}}>
                                    ...
                                    <a className="nav-link" style={{color:'gray', padding:"0px", justifyContent:"center"}}>({myBalance} BUSD)</a>
                                </div>
                            </li>
                        )}
                    </ul>
